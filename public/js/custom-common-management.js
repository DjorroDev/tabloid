...
$(document).ready(function () {
                        ...
                        for (i in response.message) {
                            ...
                            if (typeof key[1] === "undefined") {
                                ...
                                if(i == 'speakers'){
                                    ...
                                    $("#error-" + i).after('<small class="text-danger"><i>' +response.message[i] +"</i></small>");
                                }else{
                                ...
                                $("#accordion-header-error-" + key[1]).addClass("accordion-header-error");
                                $("span#warning-upload-" +key[0] +"-" +key[1]).closest(".form-group").addClass("has-error");
                                $("span#warning-upload-" +key[0] +"-" +key[1]).after('<small class="text-danger"><i>' +msg +"</i></small>");
                                $('input[type="file"][name=\'' + k + "']").closest(".form-group").addClass("has-error");
                                $('input[type="file"][name=\'' + k + "']").after('<small class="text-danger"><i>' +msg +"</i></small>");
                                $('input[type="text"][name=\'' + k + "']").closest(".form-group").addClass("has-error");
                                $('input[type="text"][name=\'' + k + "']").after('<small class="text-danger"><i>' +msg +"</i></small>");
                                $('input[type="email"][name=\'' + k + "']").closest(".form-group").addClass("has-error");
                                $('input[type="email"][name=\'' + k + "']").after('<small class="text-danger"><i>' +msg +"</i></small>");
                                $('input[type="datetime-local"][name=\'' +k +"']").closest(".form-group").addClass("has-error");
                                $('input[type="datetime-local"][name=\'' +k +"']").after('<small class="text-danger"><i>' +msg +"</i></small>");
                                $("textarea[name='" + k + "']")
                                    .closest(".form-group")
                                    .addClass("has-error");
    ...
    $("#form-common-contain-array-has-texteditor").on("submit", function (e) {
        e.preventDefault();
...
function addTerminal() {
    ...
    const template =
        ...
        set_id +
        `]" value="" class="form-control" placeholder="https://maps.app.goo.gl/Fi6fcM9Bgtg2uj349">
                                    </div>
                                </div>
